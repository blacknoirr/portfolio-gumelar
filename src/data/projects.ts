...
export const projects: Project[] = [
  {
    ...
    coverImage: "/project-terseeart/cover1.webp",
    description:
    ...
    gallery: [
      [
        "/project-terseeart/landscape1.webp",
        "/project-terseeart/landscape2.webp",
      ],
      ["/project-terseeart/landscape3.webp"],
      ["/project-terseeart/landscape4.webp"],
    ],
  },
  {
    id: "2",
    ...
    category: "Product Design",
    coverImage: "/project-workpro/cover-landscape.webp",
    description:
    ...
    gallery: [
      [
        "/project-workpro/landscape.webp",
      ],
      [
        "/project-workpro/landscape2.webp",
        "/project-workpro/landscape3.webp",
      ],
    ],
  },
  {
    ...
    coverImage: "/project-joythreaters/cover1.webp",
    description:
    ...
    gallery: [
      {
        url: "/project-joythreaters/image1.webp",
        orientation: "landscape",
      },
      {
        url: "/project-joythreaters/image2.webp",
        orientation: "landscape",
      },
      {
        url: "/project-joythreaters/image3.webp",
        orientation: "landscape",
      },
      {
        url: "/project-joythreaters/image7.webp",
        orientation: "portrait",
      },
      {
        url: "/project-joythreaters/image6.webp",
        orientation: "portrait",
      },
      {
        url: "/project-joythreaters/image4.webp",
        orientation: "landscape",
      },
      {
        url: "/project-joythreaters/image5.webp",
        orientation: "portrait",
      },
    ],
  },
  {
    ...
    category: "Photography",
    coverImage: "/project-mezita/cover1.webp",
    description:
    ...
    gallery: [
      [
        "/project-mezita/landscape1.webp",
        "/project-mezita/portrait1.webp",
        "/project-mezita/portrait2.webp",
      ],
      [
        "/project-mezita/portrait3.webp",
        "/project-mezita/portrait4.webp",
        "/project-mezita/landscape2.webp",
      ],
    ],
  },
];
