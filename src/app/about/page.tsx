export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      <h1 className="text-4xl md:text-5xl font-semibold mb-12">About</h1>

      <div className="space-y-8 text-gray-700">
        <div>
          <h2 className="text-xl font-semibold text-black mb-4">Who I Am</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold text-black mb-4">What I Do</h2>
          <p className="leading-relaxed">
            ...
            principles and believe in creating solutions that are both beautiful
            and accessible.
          </p>
        </div>
